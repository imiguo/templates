...
<form name=spend method=post action="{$settings.site_url}/comfirmegopay.php">
Your Egopay account number <b>{$account}</b><br>
...
<input type=hidden name=CUSTOM_a value=checkpaymentEgopay>
