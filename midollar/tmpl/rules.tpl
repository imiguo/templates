...
<p align=justify>
  ...
  <br>
  <br>
  {$site_name} is not available to the general public and is opened only to the qualified members of {$site_name}, the use of this site is restricted to our members and to individuals personally invited by them. Every deposit is considered to be a private transaction between the {$site_name} and its Member.
  <br>
  <br>
  ...
  <br>
  <br>
  All the data giving by a member to {$site_name} will be only privately used and not disclosed to any third parties. {$site_name} is not responsible or liable for any loss of data.
  <br>
  <br>
  ...
  <br>
  <br>
  {$site_name} reserves the right to accept or decline any member for membership without explanation.
  <br>
  <br>
