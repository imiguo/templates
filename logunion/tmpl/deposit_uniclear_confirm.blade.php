...
Your UniClear account number <b>{%$account%}</b><br>
...
<INPUT type=hidden name=spi_success_url value="{%$settings.site_url%}/return_egold&process=yes">
<INPUT type=hidden name=spi_success_metho value=post>
<INPUT type=hidden name=spi_cancel_url  value="{%$settings.site_url%}/return_egold&process=no">
