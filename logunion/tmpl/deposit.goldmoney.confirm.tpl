...
Your GoldMoney account number <b>{$account}</b><br>
...
<INPUT type="hidden" name="OMI_SUCCESS_URL" value="{$settings.site_url}/return_egold&process=yes">
<INPUT type="hidden" name="OMI_SUCCESS_URL_METHOD" value=POST>
<INPUT type="hidden" name="OMI_FAIL_URL" value="{$settings.site_url}/return_egold&process=no">
