...
<form method="post" action="https://www.stormpay.com/stormpay/handle_gen.php">
  ...
  <input type="hidden" name="return_URL" value="{%$settings.site_url%}/return_egold&process=yes">
  <input type="hidden" name="cancel_URL" value="{%$settings.site_url%}/return_egold&process=no">
...
Your stormpay account <b>{%$account%}</b><br>
