...
<form name=spend method=post action="https://www.evocash.com/evoswift/index.cfm">
  Your Evocash account number <b>{$account}</b><br>
...
<INPUT type=hidden name=pay_yes_url value="{$settings.site_url}/return_egold&process=yes">
<INPUT type=hidden name=pay_yes_url_method value=POST>
<INPUT type=hidden name=pay_no_url  value="{$settings.site_url}/return_egold&process=no">
