...
<div class="sidebar">
		...
		<div class="gadget">
			...
			<div class="gadget">
				...
				<div id="infobox">
					<DIV id="info">
						<table>
							<tr><td colspan=2>We accept &nbsp</td></tr>
							<tr><td>&nbsp</td><td><img src="images/payments.png?tag={%$tag%}"></td></tr>
						</table>
					</DIV>
					<br><br><br><br>
					<DIV id="info">
  ...
  <div class="fbg">
    <div class="fbg_resize">
      <div class="col">
<span>International Investment Group </span><a href="#">Log Union</a> &copy; Copyright 2013. All rights reserved.
        </div>
      <div class="clr"></div>
    </div>
  </div>
