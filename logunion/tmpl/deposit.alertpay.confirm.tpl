...
<INPUT type=hidden name=ap_returnurl value="{%$settings.site_url%}/?a=return_egold&process=yes">
<INPUT type=hidden name=ap_cancelurl  value="{%$settings.site_url%}/?a=return_egold&process=no">
