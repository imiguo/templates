...
Your AnonyGold account number <b>{$account}</b><br>
...
<input type=hidden name=a value=checkpayment>
 ...
 <input type=hidden name="item_id" value="Deposit">

 <input type=hidden name="return_url" value="{$settings.site_url}/?a=return_egold&process=yes">
 <input type=hidden name="notify_url" value="{$settings.site_url}/anonygold_processing.php">
 <input type=hidden name="cancel_url" value="{$settings.site_url}/?a=return_egold&process=no">
