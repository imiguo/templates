...
Fill the form available below to open an account with Log Union. Please make sure you provide us with your real information. If you have questions about this process please contact support.  Program participation is available to any individual, who is over 18 years of age.<br>
<br><br>
...
<table width="100%" border="0">
 ...
 <td valign="middle" height="30" align="right">Secret question<font color="#FF0000">*</font>:&nbsp;&nbsp;</td>
 <td valign="middle"><input type="text" style="height:20px;" size="20" class="inpts" value="{%$frm.sq|escape:"quotes"%}" name="sq"></td>

 <td valign="middle" height="30" align="right">Secret answer<font color="#FF0000">*</font>:&nbsp;&nbsp;</td>
...
<font color="#FF0000">*</font><font size="1" color="#0000FF">For Log Union,Please putt USD account. (Starts with U)</font>
        </div>
        <!--  \ TEXT BOX / -->
