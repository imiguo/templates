...
Your e-bullion account number <b>{%$account%}</b><br>
...
<input type="hidden" name="ATIP_PAYMENT_URL" value="{%$settings.site_url%}/?a=return_egold&process=yes">
<input type="hidden" name="ATIP_PAYMENT_URL_METHOD" value="POST">
<input type="hidden" name="ATIP_NOPAYMENT_URL" value="{%$settings.site_url%}/?a=return_egold&process=no">
