...
Your c-gold account number <b>{$account}</b><br>
...
<INPUT type=hidden name=payment_url value="{$settings.site_url}/?a=return_egold&process=yes">
<INPUT type=hidden name=payment_url_method value=post>
<INPUT type=hidden name=nopayment_url value="{$settings.site_url}/?a=return_egold&process=no">
