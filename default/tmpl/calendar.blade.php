...
function CalculateDiff(row, verbal)
{
  var ToDate;
  var Diff;
...
<tr>
  ...
  <td>Amount:</td><td nowrap>$ <input type="text" name="amount" value="{%$type.min_deposit%}" size=5 class=inpts> <input type="button" value="Calculate" onclick="CalculateProfit()" class=sbmt></td>
</tr>
...
<tr>
  <td>Deposit:</td><td><b><span id="deposit">N/A</span></b></td>
</tr>
