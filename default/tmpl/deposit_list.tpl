...
<tr>
 ...
 <td class=inheader width=200>Amount Spent (US$)</td>
...
<tr><td>Deposited Total:</td><td><b>${$plans[plans].total_deposit}</b></td></tr>
<tr><td>Profit Today:</td><td><b>${$plans[plans].today_profit}</b></td></tr>
<tr><td>Total Profit:</td><td><b>${$plans[plans].total_profit}</b></td></tr>
</table>
{/if}
<br>
</td></tr></table>
