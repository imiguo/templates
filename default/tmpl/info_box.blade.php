...
<tr>
	...
	<td class=menutxt align=right>$ {%$settings.info_box_deposit_funds_generated%}</td>
</tr>
{%/if%}
{%if $settings.show_info_box_today_deposit_funds == 1%}
<tr>
	<td class=menutxt><b>Today deposited</b></td>
	<td class=menutxt align=right>$ {%$settings.info_box_today_deposit_funds_generated%}</td>
</tr>
{%/if%}
{%if $settings.show_info_box_total_withdraw == 1%}
<tr>
	<td class=menutxt><b>Total withdraw</b></td>
	<td class=menutxt align=right>$ {%$settings.info_box_withdraw_funds_generated%}</td>
</tr>
{%/if%}
