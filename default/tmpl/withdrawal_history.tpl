...
<tr>
 ...
 <td align=right nowrap><b>${$periodcredit}</b></td>
 <td align=right nowrap><b>${$perioddebit}</b></td>
 <td align=right nowrap><b>${$periodbalance}</b></td>
</tr>
{/if}
<tr>
 <td colspan=2>Total:</td>
 <td align=right nowrap><b>${$allcredit}</b></td>
 <td align=right nowrap><b>${$alldebit}</b></td>
 <td align=right nowrap><b>${$allbalance}</b></td>
</tr>
</table>
{else}
<table cellspacing=1 cellpadding=2 border=0 width=100%>
...
<tr>
 ...
 <td width=200 align=right><b>$ {$trans[trans].actual_amount}</b> <img src="images/{$trans[trans].ec}.gif?tag={$tag}" align=absmiddle hspace=1 height=17> {if $trans[trans].transtype eq 'Withdrawal request'} <a href=?a=cancelwithdraw&id={$trans[trans].id} onclick="return confirm('Are you sure you want to delete this request?')">[cancel]</a>{/if}</td>
...
<tr>
 <td colspan=2>For this period:</td>
 <td align=right><b>$ {$periodsum}</b></td>
</tr>
{/if}
<tr>
 <td colspan=2>Total:</td>
 <td align=right><b>$ {$allsum}</b></td>
</tr>
</table>
{/if}
