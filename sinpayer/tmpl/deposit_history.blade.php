...
<tr>
 ...
 <td width=200 align=right><b>{%$currency_sign%} {%$trans[trans].actual_amount%}</b> <img src="images/{%if $trans[trans].ec == 3%}pm{%else%}payeer{%/if%}.gif?tag={%$tag%}" align=absmiddle hspace=1 height=17></td>
