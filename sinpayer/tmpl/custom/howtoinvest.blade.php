...
<table cellspacing=1 cellpadding=2 border=0 width=100%>
    <tr>
        ...
        <br>
        <br> Now you should active your account using login. Check your Email to see e-currency Account Number and click on Login button. Type your information and login of your account. After complete your personal information your Perfectmoney account becomes active and available for use.
        <br> After you create Perfectmoney, you will have to fund it.
        <br>
        <br>
        <b>Fund your e-currency account</b> You can use different options to fund your account:
        <ul>
        ...
        <br>
        <br>
        <b>How to withdraw your earnings</b> Earnings on your investment fund are added to your account balance every 24 hours, exactly the same time you deposited. You can withdraw your available balance at any time from Member's Area. Choose "Withdraw Funds " from account menu once you are logged in Member's Area. Select the Amount you wish to withdraw. Here you can also add any notes related to this transaction.
        <br>
        <br> Review and confirm the submitted information. Your withdrawal request will be added in our system. Our staff will process it as soon as possible, without 24 hours.
        <br>
        <br> Please note that your amount will be sent to your e-currency account. So if you have changed your E-Currency account, please contact our staff before requesting a withdrawal.
        </td>
    </tr>
</table>
