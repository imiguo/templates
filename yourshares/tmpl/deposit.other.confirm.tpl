...
<input name="a" value="deposit" type="hidden">
<input name="action" value="confirm" type="hidden">

<input name="type" value="process_1006" type="hidden">
<input name="h_id" value="1" type="hidden">
<input name="amount" value="111.00" type="hidden">
...
<font weight="bold" family="arial" size="2"><i>Provide these information after you sent funds</i></font>.
...
Amount ({$currency_sign}): <b>{$amount}</b> of {$cname}<br>
<form name=spend method=post>
{if $use_compound}
