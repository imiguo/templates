...
<tr>
 ...
 <td bgcolor="#E0E0E0" align="center" class="heading"><b>{$currency_sign}{$plans[plans].deposits[deposit].deposit} <img src="images/{$plans[plans].deposits[deposit].ec}.gif" align=absmiddle hspace=1 height=17></b></td>
{if $plans[plans].use_compound}
