...
function in_out(id, bForce)
{
  ...
  var amount =  Math.round((percent) * in_val * 100) / 100;
...
function out_in(id, bForce)
{
  ...
  var percent = Math.round(exchange[from_id][to_id] * 100) / 10000;
  var amount =  Math.round(out_val / (percent) * 100) / 100;
...
<h2>Our Exchange Rates<br />
(<font color="#FF0000">The amount you Get=The amount you Pay *RATE</font>):</h2>
<br>
