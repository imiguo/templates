		...
		<!--  \ HEADER CONTAINER / -->
			...
			<div id="menuCntr">
				...
				<ul>
					...
					{/if}
					<li><a href="?a=cust&page=aboutus"><span class="orange">.03</span>ABOUT US<span class="text">&nbsp</span></a></li>
					<li ><a href="?a=faq"><span class="orange">.04</span>F.A.Q<span class="text">&nbsp</span></a></li>
					<li><a href="?a=rules"><span class="orange">.05</span>TERMS AND CONDITIONS<span class="text">&nbsp</span></a></li>
